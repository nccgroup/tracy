...
export declare function loadAll(input: string, iterator: (document: ast.YAMLDocument) => void, options?: LoadOptions): void;
export declare function load(input: string, options?: LoadOptions): ast.YAMLNode;
export declare function safeLoadAll(input: string, output: (document: ast.YAMLDocument) => void, options?: LoadOptions): void;
