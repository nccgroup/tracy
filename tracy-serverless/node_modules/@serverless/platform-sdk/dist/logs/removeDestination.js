...
var removeLogDestination = function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _fetch2.default)(`${_config2.default.logDestinationUrl}destinations/delete`, {
              method: 'POST',
              body,
              headers: {
  ...
  return function removeLogDestination(_x) {
    return _ref2.apply(this, arguments);
  };
}();

exports.default = removeLogDestination;
