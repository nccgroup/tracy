...
func AddEvent(tracerID uint, event types.TracerEvent) ([]byte, error) {
	...
	if event.DOMContexts, err = getDomContexts(event); err == nil {
...
func getDomContexts(tracerEvent types.TracerEvent) ([]types.DOMContext, error) {
...
func getTracerLocation(n *html.Node, tracerLocations *[]types.DOMContext, tracer string, tracerEventID uint) {
